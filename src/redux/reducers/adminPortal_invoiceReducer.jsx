...
export const createManageInvoiceReducer = (state = { user: {} }, action) => {

    switch (action.type) {
         case CREATE_MANAGE_PORTAL_INVOICE_REQUEST:

        return {
            ...state,
            loading: true,
        }
    case CREATE_MANAGE_PORTAL_INVOICE_SUCCESS:
    ...
    case CREATE_MANAGE_PORTAL_INVOICE_FAIL:
