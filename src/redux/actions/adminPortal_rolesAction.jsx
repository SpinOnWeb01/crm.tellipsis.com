...
import { CREATE_ADMIN_ROLES_FAIL, CREATE_ADMIN_ROLES_REQUEST, CREATE_ADMIN_ROLES_SUCCESS, GET_ADMIN_ROLES_FAIL, GET_ADMIN_ROLES_REQUEST, GET_ADMIN_ROLES_SUCCESS, UPDATE_ADMIN_ROLES_FAIL, UPDATE_ADMIN_ROLES_REQUEST, UPDATE_ADMIN_ROLES_SUCCESS } from "../constants/adminPortal_rolesConstants";
  ...
  try {
    ...
    if (!configData) {
      ...
      dispatch({
        ...
        payload: "Portal config not found",
      });
      return;
    }
