...
import {
  ...
  getAdminRoles,
  updateAdminRoles,
} from "../../redux/actions/adminPortal_rolesAction";
...
function AdminRoles({ colorThem }) {
  ...
  }, [dispatch, response, state.portal.selectedPortal]);
  ...
  const handleUpdate = () => {
    ...
    dispatch(updateAdminRoles(request, handleEditCampaignClose, setResponse));
  };
