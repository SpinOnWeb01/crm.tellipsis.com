...
import { GET_ADMIN_LOCAL_FAIL, GET_ADMIN_LOCAL_SUCCESS } from "../../redux/constants/adminPortal/adminPortal_localConstants";
...
function AdminLocal({ colorThem }) {
  ...
  useEffect(() => {
    ...
    dispatch(getAllUsers(""));
          ...
          dispatch({ type: GET_ADMIN_LOCAL_SUCCESS, payload: [] });
        }
  }, [response, state.portal.selectedPortal]);
