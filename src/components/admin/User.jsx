...
function User({ colorThem, selectedPortal }) {
...

    {
      ...
      renderCell: (params) => (
        ...
        >
          <Typography
            variant="body2"
            sx={{ fontSize: "calc(0.4rem + 0.2vw)" }} // Match header size or set your own
          >
            {params.value}
          </Typography>
        </Tooltip>
  ...
  return (
    <>
      <div>
        <div className="contant_box users">
          <Box
